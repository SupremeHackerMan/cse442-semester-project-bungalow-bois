<?php
   ...
   session_start();
   //includes the tethys database login 
   include 'config.php';
...
function writetoDatabase(){
   ...
   document.cookie = "row0=" + r0 + "; max-age=3600";
   document.cookie = "row1=" + r1 + "; max-age=3600";
   document.cookie = "row2=" + r2 + "; max-age=3600";
   document.cookie = "row3=" + r3 + "; max-age=3600";
   document.cookie = "row4=" + r4 + "; max-age=3600";
   document.cookie = "row5=" + r5 + "; max-age=3600";
...
function selectColumn(col) {
   if(!win){
      ...
      if(determineWin(board) == 1){
         ...
         if(win){
            <?php
            include 'incrementWin.php';
            sleep(1000);
            incrWin($currentUserName);
...
<p>
   <div id="player_list" class="box">Player List
      <?php
         ...
         $link = new mysqli($HOST, $USERNAME, $USERPASSWORD, $DBNAME);
